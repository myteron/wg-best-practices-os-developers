...
<b>TODO:<br></b>
<ul>
<li>0017 to be merged into 0018</li>
<li>0018 to be moved into 03_numbers</li>
<li>verify CWE matches.</li>
</ul>
</td>
...
<td>Check Return Values<br><br>
<b>TODO:</b><br><br>
Create a follow up issue to check that the CWE, pyscg text and code examples match together. Expectation is that our pyscg0036 matches the CWE in this case<br>
CWE-252 says:<br>
...
<td>Avoid Assertions In Production<br><br>
<b>TODO:</b><br><br>
Create issue to fix:<br>
1) First sentence, as its using Exceptions as the only cure.<br>
2) Check code examples to include at least one compliant code example that is independ of raising an execption.<br>
<br>
<b>background:</b><br>
We had a discussion about moving this rule into 05_exception_handling but the root issue is for designers to include any assert code in a product envrionment. 
Using an exception as a form of proper handling is just one way of a correct implementation but the root cause remains the assert code. 
</td>
...
<td>Use Sufficiently Random Values</td>
