# pyscg-0056: Verify Package Provenance and Publisher Identity with Index-Hosted Attestations
...
Data from [OSV.dev](https://osv.dev) shows the scale malware code attacks that exists entirely outside CVE tracking.

*Malware and CVEs by year on Python based projects*

| Year | Malware (`MAL-`) | CVEs | Malware with a CVE |
| :----- | -----------------: | -----: | -------------------: |
| 2023 | 6,468\* | 497 | 0 |
| 2024 | 2,478 | 793 | 0 |
| 2025 | 1,419 | 721 | 0 |
...
CVEs on viruses or malicous code such as [CVE-2024-3094]([https://nvd.nist.gov/vuln/detail/CVE-2024-3094]) on `xz-utils` with [CWE-506](https://cwe.mitre.org/data/definitions/506.html) are rare.
